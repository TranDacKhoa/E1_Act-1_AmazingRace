        ...
        if Gold_Dog.x + 170 < WINDOWWIDTH:
            ...
            if Amulet.character_x_start[1][4] == 1:
                if Gold_Dog.dem_amulet < Amulet.time:
                    ...
                    window.blit(Amulet.surface_cham, (Gold_Dog.x + 40, Gold_Dog.y))
                else:
                ...
                if Gold_Dog.dem_amulet < Amulet.time:
                    ...
                    Gold_Dog.dem_amulet += 1
                    window.blit(Amulet.surface_choang, (Gold_Dog.x + 40, Gold_Dog.y))
                else:
                ...
                if Gold_Dog.dem_amulet < Amulet.time:
                    Gold_Dog.x -= 5
                    Gold_Dog.dem_amulet += 1
                    window.blit(Amulet.surface_quaydau, (Gold_Dog.x + 40, Gold_Dog.y))
                else:
        ...
        if Grey_Cat.x + 170 < WINDOWWIDTH:
            ...
            if Amulet.character_x_start[1][5] == 1:
                if Grey_Cat.dem_amulet < Amulet.time:
                    ...
                    window.blit(Amulet.surface_cham, (Grey_Cat.x + 40, Grey_Cat.y))
                else:
                ...
                if Grey_Cat.dem_amulet < Amulet.time:
                    ...
                    Grey_Cat.dem_amulet += 1
                    window.blit(Amulet.surface_choang, (Grey_Cat.x + 40, Grey_Cat.y))
                else:
                ...
                if Grey_Cat.dem_amulet < Amulet.time:
                    Grey_Cat.x -= 5
                    Grey_Cat.dem_amulet += 1
                    window.blit(Amulet.surface_quaydau, (Grey_Cat.x + 40, Grey_Cat.y))
                else:
        ...
        if Dinosaurs.x + 170 < WINDOWWIDTH:
            ...
            if Amulet.character_x_start[1][2] == 1:
                if Dinosaurs.dem_amulet < Amulet.time:
                    ...
                    window.blit(Amulet.surface_cham, (Dinosaurs.x + 40, Dinosaurs.y))
                else:
                ...
                if Dinosaurs.dem_amulet < Amulet.time:
                    ...
                    Dinosaurs.dem_amulet += 1
                    window.blit(Amulet.surface_choang, (Dinosaurs.x + 40, Dinosaurs.y))
                else:
                ...
                if Dinosaurs.dem_amulet < Amulet.time:
                    Dinosaurs.x -= 5
                    Dinosaurs.dem_amulet += 1
                    window.blit(Amulet.surface_quaydau, (Dinosaurs.x + 40, Dinosaurs.y))
                else:
        ...
        if Cowboy.x + 170 < WINDOWWIDTH:
            ...
            if Amulet.character_x_start[1][0] == 1:
                if Cowboy.dem_amulet < Amulet.time:
                    Cowboy.x += 3
                    Cowboy.dem_amulet += 1
                    window.blit(Amulet.surface_cham, (Cowboy.x + 40, Cowboy.y))
                else:
                ...
                if Cowboy.dem_amulet < Amulet.time:
                    Cowboy.x = Cowboy.x
                    Cowboy.dem_amulet += 1
                    window.blit(Amulet.surface_choang, (Cowboy.x + 40, Cowboy.y))
                else:
                ...
                if Cowboy.dem_amulet < Amulet.time:
                    Cowboy.x -= 5
                    Cowboy.dem_amulet += 1
                    window.blit(Amulet.surface_quaydau, (Cowboy.x + 40, Cowboy.y))
                else:
        ...
        if Cowgirl.x + 170 < WINDOWWIDTH:
            ...
            if Amulet.character_x_start[1][1] == 1:
                if Cowgirl.dem_amulet < Amulet.time:
                    ...
                    window.blit(Amulet.surface_cham, (Cowgirl.x + 40, Cowgirl.y))
                else:
                ...
                if Cowgirl.dem_amulet < Amulet.time:
                    Cowgirl.x = Cowgirl.x
                    Cowgirl.dem_amulet += 1
                    window.blit(Amulet.surface_choang, (Cowgirl.x + 40, Cowgirl.y))
                else:
                ...
                if Cowgirl.dem_amulet < Amulet.time:
                    Cowgirl.x -= 5
                    Cowgirl.dem_amulet += 1
                    window.blit(Amulet.surface_quaydau, (Cowgirl.x + 40, Cowgirl.y))
                else:
        ...
        if Ninja.x + 170 < WINDOWWIDTH:
            ...
            if Amulet.character_x_start[1][3] == 1:
                if Ninja.dem_amulet < Amulet.time:
                    Ninja.x += 3
                    Ninja.dem_amulet += 1
                    window.blit(Amulet.surface_cham, (Ninja.x + 40, Ninja.y))
                else:
                ...
                if Ninja.dem_amulet < Amulet.time:
                    Ninja.x = Ninja.x
                    Ninja.dem_amulet += 1
                    window.blit(Amulet.surface_choang, (Ninja.x + 40, Ninja.y))
                else:
                ...
                if Ninja.dem_amulet < Amulet.time:
                    Ninja.x -= 5
                    Ninja.dem_amulet += 1
                    window.blit(Amulet.surface_quaydau, (Ninja.x + 40, Ninja.y))
                else:
        ...
        if An_Nguyen.x + 170 < WINDOWWIDTH:
            ...
            if Amulet.character_x_start[1][2] == 1:
                if An_Nguyen.dem_amulet < Amulet.time:
                    ...
                    window.blit(Amulet.surface_cham, (An_Nguyen.x + 40, An_Nguyen.y))
                else:
                    Amulet.character_x_start[1][2] = 0
                    An_Nguyen.dem_amulet = 0
            elif Amulet.character_x_start[2][2] == 1:
                if An_Nguyen.dem_amulet < Amulet.time:
                    ...
                    An_Nguyen.dem_amulet += 1
                    window.blit(Amulet.surface_choang, (An_Nguyen.x + 40, An_Nguyen.y))
                else:
                    Amulet.character_x_start[2][2] = 0
                    An_Nguyen.dem_amulet = 0
            elif Amulet.character_x_start[3][2] == 1:
                if An_Nguyen.dem_amulet < Amulet.time:
                    An_Nguyen.x -= 5
                    An_Nguyen.dem_amulet += 1
                    window.blit(Amulet.surface_quaydau, (An_Nguyen.x + 40, An_Nguyen.y))
                else:
                    Amulet.character_x_start[3][2] = 0
                    An_Nguyen.dem_amulet = 0
            elif Amulet.character_x_start[4][2] == 1:
        ...
        if Dac_Khoa.x + 170 < WINDOWWIDTH:
            ...
            if Amulet.character_x_start[1][0] == 1:
                if Dac_Khoa.dem_amulet < Amulet.time:
                    ...
                    window.blit(Amulet.surface_cham, (Dac_Khoa.x + 40, Dac_Khoa.y))
                else:
                    Amulet.character_x_start[1][0] = 0
                    Dac_Khoa.dem_amulet = 0
            elif Amulet.character_x_start[2][0] == 1:
                if Dac_Khoa.dem_amulet < Amulet.time:
                    ...
                    Dac_Khoa.dem_amulet += 1
                    window.blit(Amulet.surface_choang, (Dac_Khoa.x + 40, Dac_Khoa.y))
                else:
                    Amulet.character_x_start[2][0] = 0
                    Dac_Khoa.dem_amulet = 0
            elif Amulet.character_x_start[3][0] == 1:
                if Dac_Khoa.dem_amulet < Amulet.time:
                    Dac_Khoa.x -= 5
                    Dac_Khoa.dem_amulet += 1
                    window.blit(Amulet.surface_quaydau, (Dac_Khoa.x + 40, Dac_Khoa.y))
                else:
                    Amulet.character_x_start[3][0] = 0
                    Dac_Khoa.dem_amulet = 0
            elif Amulet.character_x_start[4][0] == 1:
        ...
        if Quang_Khoa.x + 170 < WINDOWWIDTH:
            ...
            if Amulet.character_x_start[1][1] == 1:
                if Quang_Khoa.dem_amulet < Amulet.time:
                    ...
                    window.blit(Amulet.surface_cham, (Quang_Khoa.x + 40, Quang_Khoa.y))
                else:
                    Amulet.character_x_start[1][1] = 0
                    Quang_Khoa.dem_amulet = 0
            elif Amulet.character_x_start[2][1] == 1:
                if Quang_Khoa.dem_amulet < Amulet.time:
                    ...
                    Quang_Khoa.dem_amulet += 1
                    window.blit(Amulet.surface_choang, (Quang_Khoa.x + 40, Quang_Khoa.y))
                else:
                    Amulet.character_x_start[2][1] = 0
                    Quang_Khoa.dem_amulet = 0
            elif Amulet.character_x_start[3][1] == 1:
                if Quang_Khoa.dem_amulet < Amulet.time:
                    Quang_Khoa.x -= 5
                    Quang_Khoa.dem_amulet += 1
                    window.blit(Amulet.surface_quaydau, (Quang_Khoa.x + 40, Quang_Khoa.y))
                else:
                    Amulet.character_x_start[3][1] = 0
                    Quang_Khoa.dem_amulet = 0
            elif Amulet.character_x_start[4][1] == 1:
        ...
        if Dinh_Loc.x + 170 < WINDOWWIDTH:
            ...
            if Amulet.character_x_start[1][5] == 1:
                if Dinh_Loc.dem_amulet < Amulet.time:
                    ...
                    window.blit(Amulet.surface_cham, (Dinh_Loc.x + 40, Dinh_Loc.y))
                else:
                    Amulet.character_x_start[1][5] = 0
                    Dinh_Loc.dem_amulet = 0
            elif Amulet.character_x_start[2][5] == 1:
                if Dinh_Loc.dem_amulet < Amulet.time:
                    ...
                    Dinh_Loc.dem_amulet += 1
                    window.blit(Amulet.surface_choang, (Dinh_Loc.x + 40, Dinh_Loc.y))
                else:
                    Amulet.character_x_start[2][5] = 0
                    Dinh_Loc.dem_amulet = 0
            elif Amulet.character_x_start[3][5] == 1:
                if Dinh_Loc.dem_amulet < Amulet.time:
                    Dinh_Loc.x -= 5
                    Dinh_Loc.dem_amulet += 1
                    window.blit(Amulet.surface_quaydau, (Dinh_Loc.x + 40, Dinh_Loc.y))
                else:
                    Amulet.character_x_start[3][5] = 0
                    Dinh_Loc.dem_amulet = 0
            elif Amulet.character_x_start[4][5] == 1:
        ...
        if Gia_Long.x + 170 < WINDOWWIDTH:
            ...
            if Amulet.character_x_start[1][3] == 1:
                if Gia_Long.dem_amulet < Amulet.time:
                    ...
                    window.blit(Amulet.surface_cham, (Gia_Long.x + 40, Gia_Long.y))
                else:
                    Amulet.character_x_start[1][3] = 0
                    Gia_Long.dem_amulet = 0
            elif Amulet.character_x_start[2][3] == 1:
                if Gia_Long.dem_amulet < Amulet.time:
                    ...
                    Gia_Long.dem_amulet += 1
                    window.blit(Amulet.surface_choang, (Gia_Long.x + 40, Gia_Long.y))
                else:
                    Amulet.character_x_start[2][3] = 0
                    Gia_Long.dem_amulet = 0
            elif Amulet.character_x_start[3][3] == 1:
                if Gia_Long.dem_amulet < Amulet.time:
                    Gia_Long.x -= 5
                    Gia_Long.dem_amulet += 1
                    window.blit(Amulet.surface_quaydau, (Gia_Long.x + 40, Gia_Long.y))
                else:
                    Amulet.character_x_start[3][3] = 0
                    Gia_Long.dem_amulet = 0
            elif Amulet.character_x_start[4][3] == 1:
        ...
        if Khoi_Nguyen.x + 170 < WINDOWWIDTH:
            ...
            if Amulet.character_x_start[1][4] == 1:
                if Khoi_Nguyen.dem_amulet < Amulet.time:
                    ...
                    window.blit(Amulet.surface_cham, (Khoi_Nguyen.x + 40, Khoi_Nguyen.y))
                else:
                    Amulet.character_x_start[1][4] = 0
                    Khoi_Nguyen.dem_amulet = 0
            elif Amulet.character_x_start[2][4] == 1:
                if Khoi_Nguyen.dem_amulet < Amulet.time:
                    ...
                    Khoi_Nguyen.dem_amulet += 1
                    window.blit(Amulet.surface_choang, (Khoi_Nguyen.x + 40, Khoi_Nguyen.y))
                else:
                    Amulet.character_x_start[2][4] = 0
                    Khoi_Nguyen.dem_amulet = 0
            elif Amulet.character_x_start[3][4] == 1:
                if Khoi_Nguyen.dem_amulet < Amulet.time:
                    Khoi_Nguyen.x -= 5
                    Khoi_Nguyen.dem_amulet += 1
                    window.blit(Amulet.surface_quaydau, (Khoi_Nguyen.x + 40, Khoi_Nguyen.y))
                else:
                    Amulet.character_x_start[3][4] = 0
                    Khoi_Nguyen.dem_amulet = 0
            elif Amulet.character_x_start[4][4] == 1:
...
class Amulet():
    ...
    def update(Amulet):
        ...
        for i in range(0, 6):
            ...
            if Amulet.pos_x[i] == 0:
                if Amulet.pos_x_character[i] + 300 < WINDOWWIDTH - 180 and random.randrange(1, 6, 1) == i:
                    Amulet.pos_x[i] = random.randrange(Amulet.pos_x_character[i] + 50, Amulet.pos_x_character[i] + 300, 1)
